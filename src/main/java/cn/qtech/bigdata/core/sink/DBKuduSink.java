...
public class DBKuduSink extends RichSinkFunction<Map<String, String>> {
    ...
    private String tableName = AppConstants.KUDU_DATABASE + "." + AppConstants.DB_KUDU_TABLE;
    private static final Logger LOG = LoggerFactory.getLogger(DBKuduSink.class);
    ...
    public void invoke(Map<String, String> resultMap, Context context) throws Exception {
        ...
        try {
            ...
            String redisKey = AppConstants.DB_REDIS_KEY_PREFIX + deviceId;
            ...
            LOG.error(" 数据插入异常 ! DBKuduWBSink.invoke()", e);
        }
    ...
    private Boolean insertKudu(Map<String, String> resultMap) {
        ...
        try {
            ...
            LOG.error(" DBKuduWBSink.insertKudu() : insert failed !! ", e);
        }
        return false;
    ...
    public void close() throws Exception {
        ...
        try {
            ...
            LOG.error("关闭资源失败 ! DBKuduWBSink.close()", e);
        }
    }
}
