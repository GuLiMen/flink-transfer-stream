...
public class WBAREOKuduSink extends RichSinkFunction<Map<String, String>> {
    ...
    private String tableName = AppConstants.KUDU_DATABASE + "." + AppConstants.WB_AERO_KUDU_TABLE;
    private static final Logger LOG = LoggerFactory.getLogger(WBAREOKuduSink.class);
    ...
    public void invoke(Map<String, String> resultMap, Context context) throws Exception {
        ...
        try {
            ...
            String redisKey = AppConstants.WB_AERO_REDIS_KEY_PREFIX + deviceId;
    ...
    private Boolean insertKudu(Map<String, String> resultMap) {
        ...
        for (String fieldName : resultMap.keySet()) {
            ...
            String formatFieldName = fieldName.trim().toLowerCase();
